...
import com.sparklix.adminservice.service.CustomUserDetailsService; 
import com.sparklix.adminservice.util.JwtUtil; 
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtUtil jwtUtil,
                                   @Qualifier("adminUserDetailsService") CustomUserDetailsService customUserDetailsService) {
